                    ...
                    <div className="max-w-md">
                        ...
                        <div className="flex gap-5">
                            <motion.a
                                ...
                                href="https://mail.google.com/mail/?view=cm&to=neuracallbot@gmail.com"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Enviar email a Neuracall"
                            ...
                            <motion.a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="Instagram de Neuracall"
                                className="text-gray-400 hover:text-white transition-colors"
                            >
                            ...
                            <motion.a
                                whileHover={{ scale: 1.15, opacity: 1 }}
                                href="https://wa.me/5492622567533?text=Hola%21%20Me%20interesa%20Neura%20Orkesta%20%F0%9F%9A%80"
                                target="_blank"
                                rel="noopener noreferrer"
                                aria-label="WhatsApp de Neuracall"
                                className="text-gray-400 hover:text-white transition-colors"
                            >
